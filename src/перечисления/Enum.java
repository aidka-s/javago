/**
 * Демонстрация enum с инициализацией элементов и дополнительными методами (2 практики)
 * @author Student
 * @version 1.0
 */
public class Enum {

    //1: Enum с инициализацией элементов (конструктор + поля)
    public enum Day {
    ...
    //2: Enum с дополнительным методом
    public enum Planet {
    ...
    public static void main(String[] args) {
        //1: использование инициализированных enum
        System.out.println("\n 1: Enum с инициализацией");
